  ...
  <div class="container-fluid row">
    ...
    <div class="article col-9">
      <form @submit.prevent="props.action === 'create' ? submitForm() : submitUpdateForm()">
        ...
        <div class="mb-3">
          <label :for="tenMaLoaiVanBan" class="form-label text-capitalize">tenMaLoaiVanBan</label>
          <input :id="tenMaLoaiVanBan" v-model="formData.tenMaLoaiVanBan" type="text" class="form-control"
            :placeholder="`Enter tenMaLoaiVanBan`" />
        </div>

        <div class="mb-3">
          <label :for="ghiChu" class="form-label text-capitalize">ghiChu</label>
          <input :id="ghiChu" v-model="formData.ghiChu" type="text" class="form-control"
            :placeholder="`Enter ghiChu`" />
        </div>
