  ...
  <div class="container-fluid row">
    ...
    <div class="article col-9">
      ...
      >
        ...
        <div class="mb-3">
          <label :for="tenVatNuoi" class="form-label text-capitalize">tenVatNuoi</label>
          <input
            :id="tenVatNuoi"
            v-model="formData.tenVatNuoi"
            type="text"
            class="form-control"
            :placeholder="`Enter tenVatNuoi`"
          />
        </div>

        <div class="mb-3">
          <label :for="maVatNuoi" class="form-label text-capitalize">maVatNuoi</label>
          <input
            :id="maVatNuoi"
            v-model="formData.maVatNuoi"
            type="text"
            class="form-control"
            :placeholder="`Enter maVatNuoi`"
          />
        </div>

        <div class="mb-3">
          <label :for="isNhomKhac" class="form-label text-capitalize">isNhomKhac</label>
          <input
            :id="isNhomKhac"
            v-model="formData.isNhomKhac"
            type="text"
            class="form-control"
            :placeholder="`Enter isNhomKhac`"
          />
        </div>
