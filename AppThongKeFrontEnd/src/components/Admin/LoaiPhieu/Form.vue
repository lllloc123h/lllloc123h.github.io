  ...
  <div class="container-fluid row">
    ...
    <div class="article col-9">
      <form @submit.prevent="props.action === 'create' ? submitForm() : submitUpdateForm()">
        ...
        <div class="mb-3">
          <label :for="tenPhieu" class="form-label text-capitalize">tenPhieu</label>
          <input :id="tenPhieu" v-model="formData.tenPhieu" type="text" class="form-control"
            :placeholder="`Enter tenPhieu`" />
        </div>
