  ...
  <div class="container-fluid row">
    ...
    <div class="article col-9">
      ...
      >
        ...
        <div class="mb-3">
          <label :for="maTinh" class="form-label text-capitalize">maTinh</label>
          <input
            :id="maTinh"
            v-model="formData.maTinh"
            type="number"
            class="form-control"
            :placeholder="`Enter maTinh`"
          />
        </div>

        <div class="mb-3">
          <label :for="tenTinh" class="form-label text-capitalize">tenTinh</label>
          <input
            :id="tenTinh"
            v-model="formData.tenTinh"
            type="text"
            class="form-control"
            :placeholder="`Enter tenTinh`"
          />
        </div>
