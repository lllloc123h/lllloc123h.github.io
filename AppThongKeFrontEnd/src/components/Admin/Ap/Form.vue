  ...
  <div class="container-fluid row">
    ...
    <div class="article col-9">
      <form @submit.prevent="props.action === 'create' ? submitForm() : submitUpdateForm()">
        ...
        <div class="mb-3">
          <label :for="maAp" class="form-label text-capitalize">maAp</label>
          <input :id="maAp" v-model="formData.maAp" type="number" class="form-control" :placeholder="`Enter maAp`" />
        </div>

        <div class="mb-3">
          <label :for="maXa" class="form-label text-capitalize">maXa</label>
          <input :id="maXa" v-model="formData.maXa" type="number" class="form-control" :placeholder="`Enter maXa`" />
        </div>

        <div class="mb-3">
          <label :for="tenAp" class="form-label text-capitalize">tenAp</label>
          <input :id="tenAp" v-model="formData.tenAp" type="text" class="form-control" :placeholder="`Enter tenAp`" />
        </div>
