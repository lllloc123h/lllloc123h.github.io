  ...
  <div class="container-fluid row">
    ...
    <div class="article col-9">
      <form @submit.prevent="props.action === 'create' ? submitForm() : submitUpdateForm()">
        ...
        <div class="mb-3">
          <label :for="maHuyen" class="form-label text-capitalize">maHuyen</label>
          <input :id="maHuyen" v-model="formData.maHuyen" type="number" class="form-control"
            :placeholder="`Enter maHuyen`" />
        </div>

        <div class="mb-3">
          <label :for="tenHuyen" class="form-label text-capitalize">tenHuyen</label>
          <input :id="tenHuyen" v-model="formData.tenHuyen" type="text" class="form-control"
            :placeholder="`Enter tenHuyen`" />
        </div>
