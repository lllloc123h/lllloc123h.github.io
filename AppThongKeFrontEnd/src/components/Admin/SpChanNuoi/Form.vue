  ...
  <div class="container-fluid row">
    ...
    <div class="article col-9">
      <form @submit.prevent="props.action === 'create' ? submitForm() : submitUpdateForm()">
        ...
        <div class="mb-3">
          <label :for="tenSpChanNuoi" class="form-label text-capitalize">tenSpChanNuoi</label>
          <input :id="tenSpChanNuoi" v-model="formData.tenSpChanNuoi" type="text" class="form-control"
            :placeholder="`Enter tenSpChanNuoi`" />
        </div>

        <div class="mb-3">
          <label :for="isGiaCam" class="form-label text-capitalize">isGiaCam</label>
          <input :id="isGiaCam" v-model="formData.isGiaCam" type="text" class="form-control"
            :placeholder="`Enter isGiaCam`" />
        </div>
