  ...
  <div class="container-fluid row">
    ...
    <div class="article col-9">
      <form @submit.prevent="props.action === 'create' ? submitForm() : submitUpdateForm()">
        ...
        <div class="mb-3">
          <label :for="tenLoaiHinh" class="form-label text-capitalize">tenLoaiHinh</label>
          <input :id="tenLoaiHinh" v-model="formData.tenLoaiHinh" type="text" class="form-control"
            :placeholder="`Enter tenLoaiHinh`" />
        </div>
