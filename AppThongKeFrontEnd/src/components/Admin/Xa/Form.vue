      ...
      >
        ...
        <div class="mb-3">
          ...
          <input
            ...
            type="number"
            class="form-control"
            :placeholder="`Enter maXa`"
          />
        </div>

        <div class="mb-3">
          <label :for="tenXa" class="form-label text-capitalize">tenXa</label>
          <input
            :id="tenXa"
            v-model="formData.tenXa"
            type="text"
            class="form-control"
            :placeholder="`Enter tenXa`"
          />
        </div>

        <div class="mb-3">
          <label :for="isLoai" class="form-label text-capitalize">isLoai</label>
          <input
            :id="isLoai"
            v-model="formData.isLoai"
            type="text"
            class="form-control"
            :placeholder="`Enter isLoai`"
          />
        </div>
